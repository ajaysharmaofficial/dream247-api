...
const { givebonusToUser } = require("../../services/kyc-api-service/services/kycService");
            ...
            await Promise.all(
              messagesToProcess.map(async (message) => {
                try {
                  ...
                  let checkUser = await userModel.findOne({ _id: userId, "user_verify.bank_verify": 1, "fullname": obj.accountholder, "username": obj.accountholder });
